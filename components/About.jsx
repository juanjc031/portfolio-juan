        ...
        <div id='sobre' className="w-full md:h-screen p-2 flex items-center py-16">
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                <div className="col-span-2">
                    ...
                    <p className="py-2 text-[#7b7b7b]">Olá! Meu nome é Juan, tenho 17 anos e estou em busca da minha primeira oportunidade de estágio relacionada à área de desenvolvimento web, que me possa trazer novas perspectivas de futuro e crescimento em Belo Horizonte.</p>
